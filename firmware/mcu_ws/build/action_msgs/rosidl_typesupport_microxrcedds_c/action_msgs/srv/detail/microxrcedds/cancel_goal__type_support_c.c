...
typedef action_msgs__srv__CancelGoal_Event _CancelGoal_Event__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _CancelGoal_Event__ros_msg_type * ros_message = (_CancelGoal_Event__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  const _CancelGoal_Event__ros_msg_type * ros_message = (const _CancelGoal_Event__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
static size_t _CancelGoal_Event__max_serialized_size()
{
  bool full_bounded;
  return max_serialized_size_action_msgs__srv__CancelGoal_Event(&full_bounded, 0);
}
