...
typedef composition_interfaces__srv__UnloadNode_Event _UnloadNode_Event__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _UnloadNode_Event__ros_msg_type * ros_message = (_UnloadNode_Event__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  const _UnloadNode_Event__ros_msg_type * ros_message = (const _UnloadNode_Event__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
static size_t _UnloadNode_Event__max_serialized_size()
{
  bool full_bounded;
  return max_serialized_size_composition_interfaces__srv__UnloadNode_Event(&full_bounded, 0);
}
