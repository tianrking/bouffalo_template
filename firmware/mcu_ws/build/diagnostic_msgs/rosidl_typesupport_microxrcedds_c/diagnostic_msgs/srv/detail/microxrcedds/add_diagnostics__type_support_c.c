...
typedef diagnostic_msgs__srv__AddDiagnostics_Event _AddDiagnostics_Event__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _AddDiagnostics_Event__ros_msg_type * ros_message = (_AddDiagnostics_Event__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  const _AddDiagnostics_Event__ros_msg_type * ros_message = (const _AddDiagnostics_Event__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
static size_t _AddDiagnostics_Event__max_serialized_size()
{
  bool full_bounded;
  return max_serialized_size_diagnostic_msgs__srv__AddDiagnostics_Event(&full_bounded, 0);
}
