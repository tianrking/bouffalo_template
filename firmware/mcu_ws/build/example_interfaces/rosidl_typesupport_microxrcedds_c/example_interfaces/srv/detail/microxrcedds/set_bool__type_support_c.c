...
typedef example_interfaces__srv__SetBool_Event _SetBool_Event__ros_msg_type;
...
{
  bool full_bounded;
  return max_serialized_size_example_interfaces__srv__SetBool_Event(&full_bounded, 0);
}
