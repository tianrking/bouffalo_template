...
typedef example_interfaces__srv__Trigger_Event _Trigger_Event__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _Trigger_Event__ros_msg_type * ros_message = (_Trigger_Event__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  const _Trigger_Event__ros_msg_type * ros_message = (const _Trigger_Event__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
static size_t _Trigger_Event__max_serialized_size()
{
  bool full_bounded;
  return max_serialized_size_example_interfaces__srv__Trigger_Event(&full_bounded, 0);
}
