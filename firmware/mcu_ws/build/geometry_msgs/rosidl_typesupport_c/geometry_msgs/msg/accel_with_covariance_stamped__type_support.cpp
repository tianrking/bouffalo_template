...
{
#endif
rosidl_message_type_support_t * ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geometry_msgs, msg, AccelWithCovarianceStamped)();
rosidl_message_type_support_t * ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, geometry_msgs, msg, AccelWithCovarianceStamped)();
#ifdef __cplusplus
}
#endif
...
static _AccelWithCovarianceStamped_type_support_data_t _AccelWithCovarianceStamped_message_typesupport_data = {
  {
    (void*) ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geometry_msgs, msg, AccelWithCovarianceStamped),
    (void*) ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, geometry_msgs, msg, AccelWithCovarianceStamped),
  }
};
#else
static _AccelWithCovarianceStamped_type_support_data_t _AccelWithCovarianceStamped_message_typesupport_data = {
...
static rosidl_message_type_support_t AccelWithCovarianceStamped_message_type_support_handle = {
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, geometry_msgs, msg, AccelWithCovarianceStamped)() {
  if (!::geometry_msgs::msg::rosidl_typesupport_c::AccelWithCovarianceStamped_message_type_support_handle.typesupport_identifier) {
    ::geometry_msgs::msg::rosidl_typesupport_c::AccelWithCovarianceStamped_message_type_support_handle.typesupport_identifier =
    rosidl_typesupport_c__typesupport_identifier;
  }
