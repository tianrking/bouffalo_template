...
typedef lifecycle_msgs__srv__GetAvailableStates_Event _GetAvailableStates_Event__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _GetAvailableStates_Event__ros_msg_type * ros_message = (_GetAvailableStates_Event__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  const _GetAvailableStates_Event__ros_msg_type * ros_message = (const _GetAvailableStates_Event__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
static size_t _GetAvailableStates_Event__max_serialized_size()
{
  bool full_bounded;
  return max_serialized_size_lifecycle_msgs__srv__GetAvailableStates_Event(&full_bounded, 0);
}
