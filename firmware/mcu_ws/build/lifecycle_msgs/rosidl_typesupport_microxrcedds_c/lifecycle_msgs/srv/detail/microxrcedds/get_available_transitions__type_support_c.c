...
typedef lifecycle_msgs__srv__GetAvailableTransitions_Event _GetAvailableTransitions_Event__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _GetAvailableTransitions_Event__ros_msg_type * ros_message = (_GetAvailableTransitions_Event__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  const _GetAvailableTransitions_Event__ros_msg_type * ros_message = (const _GetAvailableTransitions_Event__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
static size_t _GetAvailableTransitions_Event__max_serialized_size()
{
  bool full_bounded;
  return max_serialized_size_lifecycle_msgs__srv__GetAvailableTransitions_Event(&full_bounded, 0);
}
