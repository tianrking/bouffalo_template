...
{
#endif
rosidl_message_type_support_t * ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nav_msgs, msg, OccupancyGrid)();
rosidl_message_type_support_t * ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, nav_msgs, msg, OccupancyGrid)();
#ifdef __cplusplus
}
#endif
...
static _OccupancyGrid_type_support_data_t _OccupancyGrid_message_typesupport_data = {
  {
    (void*) ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nav_msgs, msg, OccupancyGrid),
    (void*) ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, nav_msgs, msg, OccupancyGrid),
  }
};
#else
static _OccupancyGrid_type_support_data_t _OccupancyGrid_message_typesupport_data = {
...
static rosidl_message_type_support_t OccupancyGrid_message_type_support_handle = {
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, nav_msgs, msg, OccupancyGrid)() {
  if (!::nav_msgs::msg::rosidl_typesupport_c::OccupancyGrid_message_type_support_handle.typesupport_identifier) {
    ::nav_msgs::msg::rosidl_typesupport_c::OccupancyGrid_message_type_support_handle.typesupport_identifier =
    rosidl_typesupport_c__typesupport_identifier;
  }
