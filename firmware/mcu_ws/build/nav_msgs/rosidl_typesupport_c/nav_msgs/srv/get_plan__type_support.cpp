...
{
#endif
rosidl_message_type_support_t * ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nav_msgs, srv, GetPlan_Event)();
rosidl_message_type_support_t * ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, nav_msgs, srv, GetPlan_Event)();
#ifdef __cplusplus
}
#endif
...
static _GetPlan_Event_type_support_data_t _GetPlan_Event_message_typesupport_data = {
  {
    (void*) ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nav_msgs, srv, GetPlan_Event),
    (void*) ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, nav_msgs, srv, GetPlan_Event),
  }
};
#else
static _GetPlan_Event_type_support_data_t _GetPlan_Event_message_typesupport_data = {
...
static rosidl_message_type_support_t GetPlan_Event_message_type_support_handle = {
  rosidl_typesupport_c__typesupport_identifier,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, nav_msgs, srv, GetPlan_Event)() {
  if (!::nav_msgs::srv::rosidl_typesupport_c::GetPlan_Event_message_type_support_handle.typesupport_identifier) {
    ::nav_msgs::srv::rosidl_typesupport_c::GetPlan_Event_message_type_support_handle.typesupport_identifier =
    rosidl_typesupport_c__typesupport_identifier;
  }
