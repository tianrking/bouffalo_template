...
typedef nav_msgs__srv__GetMap_Event _GetMap_Event__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _GetMap_Event__ros_msg_type * ros_message = (_GetMap_Event__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  const _GetMap_Event__ros_msg_type * ros_message = (const _GetMap_Event__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
static size_t _GetMap_Event__max_serialized_size()
{
  bool full_bounded;
  return max_serialized_size_nav_msgs__srv__GetMap_Event(&full_bounded, 0);
}
