...
#include "rcl_interfaces/msg/detail/set_logger_levels_result__rosidl_typesupport_microxrcedds_c.h"
...
typedef rcl_interfaces__msg__SetLoggerLevelsResult _SetLoggerLevelsResult__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _SetLoggerLevelsResult__ros_msg_type * ros_message = (_SetLoggerLevelsResult__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  const _SetLoggerLevelsResult__ros_msg_type * ros_message = (const _SetLoggerLevelsResult__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
{
  bool full_bounded;
  return max_serialized_size_rcl_interfaces__msg__SetLoggerLevelsResult(&full_bounded, 0);
}
