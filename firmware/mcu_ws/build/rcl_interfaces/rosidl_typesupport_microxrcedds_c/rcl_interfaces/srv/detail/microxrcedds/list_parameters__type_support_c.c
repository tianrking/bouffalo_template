...
typedef rcl_interfaces__srv__ListParameters_Event _ListParameters_Event__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _ListParameters_Event__ros_msg_type * ros_message = (_ListParameters_Event__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  const _ListParameters_Event__ros_msg_type * ros_message = (const _ListParameters_Event__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
static size_t _ListParameters_Event__max_serialized_size()
{
  bool full_bounded;
  return max_serialized_size_rcl_interfaces__srv__ListParameters_Event(&full_bounded, 0);
}
