...
typedef rcl_interfaces__srv__SetParameters_Event _SetParameters_Event__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _SetParameters_Event__ros_msg_type * ros_message = (_SetParameters_Event__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  const _SetParameters_Event__ros_msg_type * ros_message = (const _SetParameters_Event__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
static size_t _SetParameters_Event__max_serialized_size()
{
  bool full_bounded;
  return max_serialized_size_rcl_interfaces__srv__SetParameters_Event(&full_bounded, 0);
}
