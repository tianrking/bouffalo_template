...
typedef rcl_interfaces__srv__SetParametersAtomically_Event _SetParametersAtomically_Event__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _SetParametersAtomically_Event__ros_msg_type * ros_message = (_SetParametersAtomically_Event__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  const _SetParametersAtomically_Event__ros_msg_type * ros_message = (const _SetParametersAtomically_Event__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
static size_t _SetParametersAtomically_Event__max_serialized_size()
{
  bool full_bounded;
  return max_serialized_size_rcl_interfaces__srv__SetParametersAtomically_Event(&full_bounded, 0);
}
