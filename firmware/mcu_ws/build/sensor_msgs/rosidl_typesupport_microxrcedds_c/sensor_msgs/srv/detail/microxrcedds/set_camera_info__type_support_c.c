...
typedef sensor_msgs__srv__SetCameraInfo_Event _SetCameraInfo_Event__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _SetCameraInfo_Event__ros_msg_type * ros_message = (_SetCameraInfo_Event__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  const _SetCameraInfo_Event__ros_msg_type * ros_message = (const _SetCameraInfo_Event__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
static size_t _SetCameraInfo_Event__max_serialized_size()
{
  bool full_bounded;
  return max_serialized_size_sensor_msgs__srv__SetCameraInfo_Event(&full_bounded, 0);
}
