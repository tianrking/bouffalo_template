...
typedef test_msgs__action__Fibonacci_SendGoal_Event _Fibonacci_SendGoal_Event__ros_msg_type;
...
{
  bool full_bounded;
  return max_serialized_size_test_msgs__action__Fibonacci_SendGoal_Event(&full_bounded, 0);
}
...
typedef test_msgs__action__Fibonacci_GetResult_Event _Fibonacci_GetResult_Event__ros_msg_type;
...
{
  bool full_bounded;
  return max_serialized_size_test_msgs__action__Fibonacci_GetResult_Event(&full_bounded, 0);
}
