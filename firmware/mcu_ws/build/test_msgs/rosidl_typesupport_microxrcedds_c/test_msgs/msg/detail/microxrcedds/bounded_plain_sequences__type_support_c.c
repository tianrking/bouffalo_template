...
#include "test_msgs/msg/detail/bounded_plain_sequences__rosidl_typesupport_microxrcedds_c.h"
...
typedef test_msgs__msg__BoundedPlainSequences _BoundedPlainSequences__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _BoundedPlainSequences__ros_msg_type * ros_message = (_BoundedPlainSequences__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  const _BoundedPlainSequences__ros_msg_type * ros_message = (const _BoundedPlainSequences__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
{
  bool full_bounded;
  return max_serialized_size_test_msgs__msg__BoundedPlainSequences(&full_bounded, 0);
}
