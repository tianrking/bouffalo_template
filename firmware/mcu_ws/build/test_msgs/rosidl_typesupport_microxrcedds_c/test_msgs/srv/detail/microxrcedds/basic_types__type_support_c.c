...
typedef test_msgs__srv__BasicTypes_Event _BasicTypes_Event__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _BasicTypes_Event__ros_msg_type * ros_message = (_BasicTypes_Event__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  const _BasicTypes_Event__ros_msg_type * ros_message = (const _BasicTypes_Event__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
static size_t _BasicTypes_Event__max_serialized_size()
{
  bool full_bounded;
  return max_serialized_size_test_msgs__srv__BasicTypes_Event(&full_bounded, 0);
}
