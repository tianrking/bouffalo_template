...
#include "type_description_interfaces/msg/detail/key_value__rosidl_typesupport_microxrcedds_c.h"
...
typedef type_description_interfaces__msg__KeyValue _KeyValue__ros_msg_type;
...
{
  bool full_bounded;
  return max_serialized_size_type_description_interfaces__msg__KeyValue(&full_bounded, 0);
}
