...
{
#endif
rosidl_message_type_support_t * ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, visualization_msgs, msg, MeshFile)();
rosidl_message_type_support_t * ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, visualization_msgs, msg, MeshFile)();
#ifdef __cplusplus
}
#endif
...
static _MeshFile_type_support_data_t _MeshFile_message_typesupport_data = {
  {
    (void*) ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, visualization_msgs, msg, MeshFile),
    (void*) ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, visualization_msgs, msg, MeshFile),
  }
};
#else
static _MeshFile_type_support_data_t _MeshFile_message_typesupport_data = {
...
static rosidl_message_type_support_t MeshFile_message_type_support_handle = {
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, visualization_msgs, msg, MeshFile)() {
  if (!::visualization_msgs::msg::rosidl_typesupport_c::MeshFile_message_type_support_handle.typesupport_identifier) {
    ::visualization_msgs::msg::rosidl_typesupport_c::MeshFile_message_type_support_handle.typesupport_identifier =
    rosidl_typesupport_c__typesupport_identifier;
  }
